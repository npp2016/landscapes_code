...
NOTE: Points were chosen to show variation in measures (if two points seemed similar in tree/shrub cover, one was excluded). Points where accessibility was low (i.e. on a steep slope) were not covered.
...
**Figure 11** Shrub size by site. NOTE: Not scaled by the number of sites sampled.
